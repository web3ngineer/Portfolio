      ...
      <div className="flex flex-col-reverse gap-4 md:gap-0 items-center md:flex-row justify-between">
        <div className="flex flex-col items-center md:items-start">
          ...
          <TypewriterEffectSmooth
            words={words}
            className="font-mono mb-4 mt-0 text-base md:text-xl"
          />
          
          <p className="text-gray-700 dark:text-gray-300 text-center md:text-start mb-2">
            Specializing in creating intuitive user interfaces with React and
            building robust APIs using Node.js and Django, I focus on delivering
            high-performance web applications tailored to meet user needs.
          </p>
